...
import { ArrowLeft, PackageCheck, ShieldCheck } from "lucide-react-native";
...
export default function OwnerListingVerificationScreen() {
  ...
  const handleNextCreate = () => {
    router.push(`/owner/payment?plan=${currentPlan}` as any);
  };

  const handleNextEdit = () => {
    router.push(`/owner/success?mode=edit&plan=${currentPlan}` as any);
  };
      ...
      <SafeAreaView style={styles.safeArea}>
        ...
        <View style={styles.loadingBox}>
          ...
          <Text style={styles.loadingText}>
            {isId
              ? "Memuat verifikasi listing..."
              : "Loading listing verification..."}
          </Text>
        </View>
      </SafeAreaView>
    );
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <View style={styles.stepBar}>
        <View style={styles.stepIcon}>
          <ShieldCheck color="#e6c15c" size={19} />
        </View>

        <View style={styles.stepTextBox}>
          <Text style={styles.stepKicker}>STEP 4</Text>
          <Text style={styles.stepTitle}>
            {isId ? "Konfirmasi Kepemilikan" : "Ownership Confirmation"}
          </Text>
        </View>
      ...
      <ListingVerifikasi
        ...
        setDraft={setDraft}
        onBack={handleBack}
        onNextCreate={handleNextCreate}
        onNextEdit={handleNextEdit}
        language={language}
      />
    </SafeAreaView>
  );

...
import { ArrowLeft, Languages, MapPin } from "lucide-react-native";
...
export default function AgentEditListingScreen() {
  ...
  useEffect(() => {
    ...
    async function loadListing() {
      if (!kode) {
        setErrorMessage(isId ? "Kode listing tidak ditemukan." : "Listing code not found.");
        setLoading(false);
        return;
      }
      ...
      try {
        ...
        if (!ignore) {
          console.log("Tetamo mobile agent edit load error:", error);
          setErrorMessage(
            error?.message ||
      ...
      <SafeAreaView style={styles.safeArea}>
        ...
        <View style={styles.loadingBox}>
          ...
          <Text style={styles.loadingText}>
            {isId ? "Memuat listing agent..." : "Loading agent listing..."}
          </Text>
        </View>
      </SafeAreaView>
    );
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <View style={styles.stepBar}>
        <View style={styles.stepIcon}>
          <MapPin color="#e6c15c" size={19} />
        </View>

        <View style={styles.stepTextBox}>
          <Text style={styles.stepKicker}>
            {isId ? "AGENT EDIT STEP 1" : "AGENT EDIT STEP 1"}
          </Text>
          <Text style={styles.stepTitle}>
            {isId ? "Lokasi Listing" : "Listing Location"}
          </Text>
        </View>

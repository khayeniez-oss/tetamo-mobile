...
export default function AgentListingDetailsScreen() {
  ...
  useEffect(() => {
    ...
    async function checkAgentAccess() {
      ...
      try {
        ...
        if (authError || !user) {
          router.push(
            "/login?role=agent&next=/agent/listing-details" as any
          );
          return;
        }
  ...
  }, [draftRecord, activeMembership, listingLimit, usedSlots, remainingSlots]);
  ...
  function handleNext() {
    ...
    router.push("/agent/listing-media" as any);
  }
      ...
      <View style={styles.stepBar}>
        ...
        <View style={styles.stepTextBox}>
          <Text style={styles.stepKicker}>
            {isId ? "AGENT STEP 2" : "AGENT STEP 2"}
          </Text>
